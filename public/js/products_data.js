const productsData = [
  {
    ...
    description:
      "Single-origin light roast with floral notes. Available in Whole Bean, Fine, Medium, Coarse.",
  },
  {
    id: "102",
    ...
    description:
      "Smooth and balanced medium roast. Available in Whole Bean, Fine, Medium, Coarse.",
  },
  {
    id: "103",
    ...
    description:
      "Rich and intense dark roast. Available in Whole Bean, Fine, Medium, Coarse.",
  },
  {
    id: "104",
    ...
    description:
      "Unique low-acidity bean exposed to monsoon winds. Available in Whole Bean, Fine, Medium, Coarse.",
  },
  {
    id: "105",
    ...
    description:
      "Our signature daily blend. Available in Whole Bean, Fine, Medium, Coarse.",
  },
  {
    id: "106",
    ...
    description:
      "Perfectly crafted for espresso shots. Available in Whole Bean, Fine, Medium, Coarse.",
  },
  {
    id: "107",
    ...
    description:
      "Bright and energizing morning cup. Available in Whole Bean, Fine, Medium, Coarse.",
  },
  {
    id: "201",
  ...
  {
    //adding new product-1
    id: "999",
    name: "Web LAB Special Coffee Blend",
    category: "Coffee Powders",
    price: "500.00",
    image: "/assets/products/brazilian-roast.png",
  ...
  {
    id: "1000",
    name: "WEB LAB EXAM SPECIAL COFFEE",
    category: "Ready-to-Drink",
    price: "320.00",
    image: "/assets/products/iced-latte.png",
    description:"Special Blend for Web Lab internal exams"
  }
];
